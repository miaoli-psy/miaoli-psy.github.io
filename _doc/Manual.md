...
```yml
# Site settings
title: Miao Blog             # title of your website
SEOTitle: Miao Blog          # check out docs for more detail
...
It's possible that you want the two things different. For me, my site-title is **“Miao Blog”** but I want the title shows in search engine is **“黄玄的博客 | Miao Blog”** which is multi-language.
